...
#ifdef NEW_PINS
const uint8_t BUTTON_0 = P0;   //P0 Einstellung für Platinenversion
const uint8_t BUTTON_1 = P3;   //P3
const uint8_t BUTTON_2 = P1;   //P1
const uint8_t BUTTON_3 = P4;   //P4
const uint8_t BUTTON_4 = P2;   //P2
const uint8_t BUTTON_5 = P5;   //P5
const uint8_t BUTTON_6 = P10;   //P10
const uint8_t BUTTON_7 = P8;   //P8
const uint8_t BUTTON_8 = P9;  //P9
const uint8_t BUTTON_9 = P12;  //P12
const uint8_t BUTTON_10 = P11; //P11
#else
