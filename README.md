...
## Case
A Fusion360 model of the case, as well as STL files, are included in the CADDeck repository. The main case is printed in four pieces. The two top sections are bolted together internal to the case with M3 cap screws and nuts.
